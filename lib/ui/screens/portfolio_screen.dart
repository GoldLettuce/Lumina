...
class SummaryVM {
  ...
  final double initialValueUsd; // Precálculo para evitar trabajo en scrub
...
class PortfolioSummaryMinimal extends StatelessWidget {
  ...
  // Valor inicial ya precalculado y memoizado en el Selector
...
class AssetListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final showIcons = context.select<SettingsProvider, bool>(
      (s) => s.showAssetIcons,
         ); // Evita rebuilds por otros ajustes
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Selector<SpotPriceProvider, int>(
                                                 selector:
                             (_, p) =>
                                 p.pricesVersion, // Versión fiable y barata
                        builder: (_, __, ___) {
                          WidgetsBinding.instance.addPostFrameCallback((_) {
                        ...
                        selector: (_, h, fx, inv) {
                          final investments = inv.investments
                              ...
                              .toList(growable: false);
                                                     ...
                                                     // Fecha más antigua de todas las operaciones
                          DateTime? firstDate;
                          ...
                          if (firstDate != null) {
                            final startDate = DateTime(
                              ...
                              firstDate.day,
                                                         ...
                                                         // Leer caches una vez (evitamos trabajo durante el scrub)
                            final key =
