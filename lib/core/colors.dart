...
class AppColors {
  ...
  static const darkOnSurface = Color(
    0xB3FFFFFF,
  ); // 70% blanco para texto secundario
...
const Color sellButtonBlueSelectedLight = Color(
  0xFF1565C0,
); // Seleccionado claro
const Color sellButtonBlueSelectedDark = Color(
  0xFF448AFF,
); // Seleccionado oscuro

// Botón de VENTA (SELL) minimalista
const Color sellButtonNeutralLight = Color(
  0xFFC2D4E5,
); // Modo claro (ajustado con azul suave)
...
const Color buyButtonGreenLight = Color(
  0xFFDFF5E3,
); // no seleccionado (modo claro)
const Color buyButtonGreenSelectedLight = Color(
  0xFF98C7A7,
...
const Color cancelButtonTextLight = Color(
  0xFFBB4444,
); // Texto rojo más fuerte (claro)
const Color cancelButtonTextDark = Color(
  0xFFFF8888,
); // Texto rojo suave vibrante (oscuro)
...
const Color selectedTileMonoLight = Color(
  0xFFE8E8E8,
